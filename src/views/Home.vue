<template>
  <div id="bc" class="login box column is-half is-offset-one-quarter mt-6">
    <form @submit.prevent="login">
      ...
      <b-field label="Email :">
        <b-input type="email" maxlength="30" v-model="email" required placeholder="Ex : theo@mail.fr">
        </b-input>
      </b-field>

      <b-field label="Password :">
        <b-input type="password" v-model="password" required placeholder="Ex : fhq7h"> </b-input>
      </b-field>
